...
logging.basicConfig(filename='musicbrainz.txt', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
#logging.disable()
...
def main():
    ...
    results = query_by_name(ARTIST_URL, query_type["simple"], "One AND Direction")
